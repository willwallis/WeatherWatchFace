...
import com.example.android.sunshine.app.SendDataService;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    // Use same service to update watch and create notification, using a single data call
    private void notifyWeather() {
        ...
        if (cursor.moveToFirst()) {
            ...
            // CALL WATCH API HERE
            Intent sendIntent = new Intent(context, SendDataService.class);
            sendIntent.putExtra(KEY_ONE, weatherId);
            sendIntent.putExtra(KEY_TWO, high);
            sendIntent.putExtra(KEY_THREE, low);
